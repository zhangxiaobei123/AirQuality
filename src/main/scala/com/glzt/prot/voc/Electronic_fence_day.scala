...
/**
 * @Author:Tancongjian
 * @Date:Created in 11:37 2022/3/23
 *
 */
object Electronic_fence_day {
...
//      .master("local[*]")
    ...
    val star_time = FormatTimeUtil.getdayTime(1)
    println(star_time)


    val tableName = s"(SELECT * FROM daydata where avgdate>='" + star_time + "') t"
//    val tableName = s"(SELECT * FROM $tabled where avgdate<'2022-03-23 00:00:00') t"
