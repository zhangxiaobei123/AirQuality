package com.glzt.prot.evaluate.whole_51
...
object WholeQuarter2TiDB51App {
  def main(args: Array[String]): Unit = {
    ...
    spark.sql(
      s"""
         |insert overwrite table dwm_air.dwm_whole_forecast_evaluate_quarter_cd partition(dt='${year}_${lastQuarter}')
