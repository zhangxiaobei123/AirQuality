  ...
  def main(args: Array[String]): Unit = {
    ...
    val df4 = spark.sql(
      s"""
         ...
         |accuracy from dwm_air.dwm_whole_forecast_evaluate_month_two
         |union all
         |select
         |control_area_id               ,
         |time_step                     ,
    ...
    spark.sql(
      s"""
         |insert overwrite table dwm_air.dwm_whole_forecast_evaluate_day_two partition(dt='${day}')
