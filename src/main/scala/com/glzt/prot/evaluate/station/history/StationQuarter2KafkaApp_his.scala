package com.glzt.prot.evaluate.station.history
...
object StationQuarter2KafkaApp_his {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val date = tmpGetMonthList(args(0)).map("'" + _ + "'").mkString(",")
    val year = tmpGetMonthList(args(0)).head.substring(0, 4)
    var lastQuarter = ""
...
val df2 = df
  ...
  def tmpGetMonthList(quarter: String): List[String] = {
    var a = ""
    var b = ""
    var c = ""
    quarter match {
